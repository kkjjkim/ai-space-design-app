...
- [ ] ⚠️ 미용실 랜딩 히어로 이미지가 업종과 안 맞음 — 컨셉 이미지 10장 중 미용실이 없어
      라이프스타일 편집샵(nest.jpg)을 임시로 씀. 전용 히어로 이미지 생성 필요.
      (AGENTS.md 7번상 히어로 분위기 이미지는 AI 생성 허용)
- [ ] 인사이트 새 글 6편 전용 커버도 미제작 (컨셉 이미지 재사용 중)
